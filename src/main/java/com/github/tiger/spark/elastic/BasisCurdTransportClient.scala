...
class BasisCurdTransportClient(settings: Settings, transportAddresses: Array[TransportAddress])
  ...
  private val _transportClient = TransportClientSingleton
...
object BasisCurdTransportClient {
  ...
  def main(args: Array[String]): Unit = {
    ...
    //    client.createIndex("spark-streaming")

    //    client.deleteIndex("spark-streaming")

    val queryString = "jobNum:*"
    client.deleteDocumentByQuery(Array("spark-streaming"),
      QueryBuilders.queryStringQuery(queryString))

//    client.deleteDocumentOneById("spark-streaming", "user-behavior-user-total", "d41d8cd98f00b204e9800998ecf8427e")
//
